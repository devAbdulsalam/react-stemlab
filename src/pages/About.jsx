            ...
            <div className="flex flex-col flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center">
              <div className="flex flex-col mb-10 lg:items-start items-center">
                ...
                <div className="flex-grow text-base leading-relaxed">
                  ...
                  <button className="mt-3 learn-more-link blue inline-flex items-center bg-bg font-bold md:text-base text-sm py-2 px-10 text-center text-primary bg-secondary hover:bg-primary hover:text-secondary cursor-pointer uppercase opacity-90">
                    {" "}
                    Learn More
                    <svg
                      fill="none"
